                ...
                <div className="w-full mx-auto px-2 sm:px-4 py-2">
                    <div className="mb-2">
                        <div className="flex justify-between items-center mb-4">
                            <h1 className="text-2xl font-bold text-gray-900">KPI Tambahan</h1>
                        </div>
                                        ...
                                        <tr key={row.id} className="border-b border-gray-200 hover:bg-emerald-50 transition-colors">
                                            ...
                                            {currentColumns.map((col) => {
                                                ...
                                                if (isSpreadsheetMode) {
                                                    ...
                                                    if (col.type === 'select-agama' || col.type === 'select-bangsa') {
                                                        const dropdownOptions = col.type === 'select-agama' ? religions : races;
                                                        const placeholder = col.type === 'select-agama' ? 'Pilih Agama' : 'Pilih Bangsa';
